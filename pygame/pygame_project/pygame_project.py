...
# 화면 타이틀 설정
pygame.display.set_caption("파이썬 노잼")
...
# 스테이지 만들기
stage = pygame.image.load(os.path.join(image_path, "background3.png"))
stage_size = stage.get_rect().size
stage_height = stage_size[1] # 스테이지의 높이 위에 캐릭터를 두기 위해 사용

# 캐릭터 만들기
character = pygame.image.load(os.path.join(image_path, "ch.png"))
...
# 무기 만들기
weapon = pygame.image.load(os.path.join(image_path, "we.png"))
